 ...
 * 
 */
class ValidatorIsFloat extends ValidatorAbstract implements IValidator {
	 ...
	 * 
	 */		
	protected $_message = 'It is not valid float';
	...
	/**	
	 * Sprawdza poprawnosc liczby zmiennoprzecinkowej
	 * 
	 * @access public
	...
	public function reset() {
		parent::reset();
		$this->_message = 'It is not valid float';
	}			
