 ...
 * 
 */
class ValidatorAlphaNumeric extends ValidatorAbstract implements IValidator {
	 ...
	 * 
	 */		
	protected $_message = 'It is not valid alpahumeric string';
	...
	/**	
	 * Sprawdza poprawnosc ciagu zawierajacego tylko litery i cyfry
	 * 
	 * @access public
	...
	public function reset() {
		parent::reset();
		$this->_message = 'It is not valid alpahumeric string';
	}		
