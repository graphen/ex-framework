 ...
 * 
 */
class ValidatorIp6 extends ValidatorAbstract implements IValidator {
	 ...
	 * 
	 */		
	protected $_message = 'It is not valid IP ver. 6';
	...
	/**	
	 * Sprawdza poprawnosc adresu IP ver. 6
	 * 
	 * @access public
	...
	public function reset() {
		parent::reset();
		$this->_message = 'It is not valid IP ver. 6';
	}	
