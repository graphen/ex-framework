 ...
 * 
 */
class SaServer extends SaAbstract implements ISa {
	...
	public function __construct(IFilterComposite $filterComposite, IFilter $stripSlashesFilter) {
		parent::init('SERVER', $filterComposite);
		$this->addFilter($stripSlashesFilter);		
	}
	
	/**
	 * Zwraca wartosc danej zmiennej z tablicy $_SERVER lub cala tablice
	 * 
	 * @access public
	...
	/**
	 * Zwraca surowa wartosc podanej zmiennej z tablicy $_SERVER
	 * 
	 * @access public
	 * @param string Nazwa zmiennej
	 * @return string|null
