...
class ProfileRegisterForm extends BaseControllerActionAbstract implements IController {
	...
	protected $_templateName = 'profileRegisterForm';
	...
	public function execute() {
		...
		$values = $this->_session->getFlashData('profileRegisterFormValues');
		$errors = $this->_session->getFlashData('profileRegisterErrors'); //przepuscic przez i18n
		...
		//przygotowanie tablicy z danymi uzytkownika w przypadku kiedy podczas wypelniania wystapily bledy
		$userToView = array();
		if(is_array($values)) {
		...
		$actionLink = $baseUrl.'/profile/register';
		...
		$this->_view->assign('profileRegisterFormTitle', $this->_i18n->translate('Profile register form'));		
